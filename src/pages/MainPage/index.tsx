        ...
        <View style={{ height: '100%' }}>
            <ScrollView style={{ height: '100%' }} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.wrapperImage}>
                    <Image source={require('./assets/banner2.png')} style={styles.banner2} resizeMode='contain' />
                </View>
                <Text style={styles.text3}>
                    Дорогой друг!
                    Перед тобой стоит выбор направления обучения и будущей профессии. Это очень важный
                    шаг для каждого человека, от правильности которого зависит многое в твоей жизни.
                    ...
                    обучение и пригодится ли оно в будущем...
                    ...
                    современной, а также интересной и увлекательной.
                ...
                <Text style={styles.text3}>
                    ...
                    различные ситуации из которых успешно выбирался - целое приключение!
                    ...
                    А риск, основанный на знаниях законов экономики и финансов - практически гарантирует успех!
